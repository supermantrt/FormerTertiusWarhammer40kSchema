...
ix.config.Add("safeInvWidth", 7, "How many slots in a row there is in a safebox inventory.", nil, {
	data = {min = 0, max = 20},
	category = PLUGIN.name
})

ix.config.Add("safeInvHeight", 7, "How many slots in a column there is in a safebox inventory.", nil, {
	data = {min = 0, max = 20},
	category = PLUGIN.name
})
