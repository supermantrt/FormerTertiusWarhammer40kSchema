ITEM.name = "ID Manifest"
ITEM.model = Model("models/jackswan/wk_forttab.mdl")
ITEM.description = "Commonly issued out to the citizens in the East province of the continent, military personel are required to carry this by Imperial Law."
...
ITEM.functions.viewrecord = {
	...
	OnRun = function(item)
		...
		if client:Team() == FACTION_CMDC or client:Team() == FACTION_GM or client:Team() == FACTION_MEC then
