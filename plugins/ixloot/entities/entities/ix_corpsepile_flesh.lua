...
ENT.Type             = "anim"
ENT.PrintName        = "Corpse Pile Flesh"
...
if ( SERVER ) then
    function ENT:Initialize()
        self:SetModel("models/muschi/props/muschi_prop_detail_psyker_bodyes_many.mdl")
    ...
    function ENT:SpawnFunction(ply, trace)
        ...
        local entity = ents.Create("ix_corpsepile_flesh")
