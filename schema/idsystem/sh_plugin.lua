...
if CLIENT then
	...
	netstream.Hook("SubmitNewCID", function(ply, data)
		if ply:Team() == FACTION_CMDC or ply:Team() == FACTION_GM or ply:Team() == FACTION_MEC then
...
PLUGIN:AddLoyaltyItem("Ration Pack", "models/weapons/w_package.mdl", "Imperial issued rations, unpack it to get yourself some suppliments and water.", {
	["Ration"] = 1
}, "Ration", 12000)

PLUGIN:AddLoyaltyItem("Standard Wages", "models/props_lab/box01b.mdl", "A small box of standard wages, containing 10 tokens.", {
	["tokens"] = 10
}, "tokens", 12000)